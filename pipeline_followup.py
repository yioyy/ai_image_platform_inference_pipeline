...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        ...
        nargs="+",
        default=[
            "/data/4TB1/pipeline/chuan/example_input/00130846_20220105_MR_E211126000320/Pred_CMB.nii.gz",
            "/data/4TB1/pipeline/chuan/example_input/00130846_20220105_MR_E211126000320/SynthSEG_CMB.nii.gz",
        ],
    )
    p.add_argument(
        "--baseline_DicomDir",
        default="/data/4TB1/pipeline/chuan/example_inputDicom/00130846_20220105_MR_E211126000320/SWAN",
        help="baseline的dicom資料夾",
    )
    p.add_argument(
        "--baseline_DicomSegDir",
        default="/data/4TB1/pipeline/chuan/example_inputDicom/00130846_20220105_MR_E211126000320/Dicom-Seg",
        help="baseline的dicom-seg資料夾",
    )
    p.add_argument(
        "--baseline_json",
        default="/data/4TB1/pipeline/chuan/example_input/00130846_20220105_MR_E211126000320/Pred_CMB_platform_json.json",
        help="baseline的json資料夾",
    )
    ...
    p.add_argument(
        ...
        nargs="+",
        default=[
            "/data/4TB1/pipeline/chuan/example_input/00130846_20210409_MR_21003160054/Pred_CMB.nii.gz",
            "/data/4TB1/pipeline/chuan/example_input/00130846_20210409_MR_21003160054/SynthSEG_CMB.nii.gz",
        ],
    )
    p.add_argument(
        "--followup_DicomSegDir",
        default="/data/4TB1/pipeline/chuan/example_inputDicom/00130846_20210409_MR_21003160054/Dicom-Seg",
        help="followup的dicom-seg資料夾",
    )
    p.add_argument(
        "--followup_json",
        default="/data/4TB1/pipeline/chuan/example_input/00130846_20210409_MR_21003160054/Pred_CMB_platform_json.json",
        help="followup的json資料夾",
    )

    p.add_argument(
        "--path_output",
        default="/data/4TB1/pipeline/chuan/example_output/00130846_20220105_MR_E211126000320/",
        help="輸出資料夾",
    )
