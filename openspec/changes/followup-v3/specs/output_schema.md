...
```
{
  ...
  "followup_series_instance_uid": "string",
  "sorted": [
    {"current_slice": 1, "followup_slice": 2},
    {"current_slice": 2, "followup_slice": 3}
  ],
  "reverse-sorted": [
    {"followup_slice": 1, "current_slice": 1},
    {"followup_slice": 2, "current_slice": 1},
    {"followup_slice": 3, "current_slice": 2}
  ]
}
```
...
- `sorted`：以 current_date 滾輪為主時的對照表（`current_slice -> followup_slice`）
- `reverse-sorted`：以 prior_date 滾輪為主時的對照表（`followup_slice -> current_slice`）
- `current_slice` / `followup_slice` 從 1 開始，且為嚴格一對一對照
  ...
  "sorted_slice": [
    {
      ...
      "sorted": [
        {"current_slice": 1, "followup_slice": 1},
        {"current_slice": 2, "followup_slice": 2}
      ],
      "reverse-sorted": [
        {"followup_slice": 1, "current_slice": 1},
        {"followup_slice": 2, "current_slice": 2},
        {"followup_slice": 3, "current_slice": 2}
      ]
    },
    {
